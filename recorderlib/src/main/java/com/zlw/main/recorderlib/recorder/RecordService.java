...
import com.zlw.main.recorderlib.recorder.listener.RecordVolumeListener;
...
public class RecordService extends Service {
    ...
    public static void setRecordVolumeListener(RecordVolumeListener recordVolumeListener) {
        RecordHelper.getInstance().setRecordVolumeListener(recordVolumeListener);
    }
